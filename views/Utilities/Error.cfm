<cfoutput>
  <div class="px-4 py-3 my-10 text-teal-900 bg-red-100 border-t-4 border-red-500 rounded-b shadow-md" role="alert">
    <div class="flex">
      ...
      <div>
        <p class="font-bold">So sorry - there was an error rendering this page.</p>
        <p class="text-sm">#encodeForHTML( prc.exception.message )#</p>
      </div>
    </div>
  </div>
